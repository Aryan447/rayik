...
import app.rayik.music.innertube.models.MusicCardShelfRenderer
...
import app.rayik.music.innertube.models.toArtists
...
data class HomePage(
    ...
    data class Section(
        ...
        companion object {
            ...
            private fun List<app.rayik.music.innertube.models.Run>.toPodcastArtist(): Artist? =
            ...
            private fun List<app.rayik.music.innertube.models.Run>.toPodcastAuthor(): Artist? =
                toPodcastArtist()
            ...
            private fun List<app.rayik.music.innertube.models.Run>.episodeDateText(podcastName: String?): String? =
                firstOrNull { run ->
            ...
            private fun app.rayik.music.innertube.models.Run.isPodcastMetadataText(): Boolean {
