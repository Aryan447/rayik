...
-keep class app.rayik.music.models.PersistQueue { *; }
-keep class app.rayik.music.models.PersistPlayerState { *; }
-keep class app.rayik.music.models.QueueData { *; }
-keep class app.rayik.music.models.QueueType { *; }
-keep class app.rayik.music.playback.queues.** { *; }
