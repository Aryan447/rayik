...
/**
 * Google sign-in for the YouTube session, hosted in a WebView.
 * Mirrors the upstream capture flow: cookies + visitor data + datasync id
 * are harvested on YouTube pages and completed through [LoginViewModel].
 */
    ...
    AndroidView(
      ...
      factory = { factoryContext ->
        WebView(factoryContext).apply {
          ...
          webView = this
          resetAuthWebViewSession(factoryContext, this, clearCookies = true) {
