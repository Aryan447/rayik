...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: app.rayik.music.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: app.rayik.music.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: app.rayik.music.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is app.rayik.music.together.JoinDecision -> {
                            ...
                            is app.rayik.music.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
