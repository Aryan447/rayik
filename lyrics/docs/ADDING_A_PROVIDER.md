...
lyrics/yourprovider/
├── build.gradle.kts
└── src/main/kotlin/app/rayik/music/yourprovider/
    └── YourProvider.kt
```
...
```kotlin
package app.rayik.music.yourprovider
...
```
app/src/main/kotlin/app/rayik/music/lyrics/YourProvider.kt
```
...
import app.rayik.music.yourprovider.YourProvider
...
```
lyrics/yourprovider/src/main/kotlin/app/rayik/music/yourprovider/
├── YourProvider.kt
└── models/
    ├── SearchResponse.kt
    └── LyricsResponse.kt
...
| Package format: `app.rayik.music.<name>` | Matches existing convention |
